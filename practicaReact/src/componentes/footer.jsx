  ...
  return (
	<footer className=' bordered border-top mt-5 bg-light'>
		<div className='container'>
			<div className='row'>
				<div className='col-12 d-flex flex-sm-column justify-content-between align-items-center'>
					<img src='/public/logo_provisional-sinfondo.png'/>
					<div className='d-flex gap-4 flex-sm-column justify-content-center align-items-center'>
						<div>
							<ul className='list-unstyled text-end text-sm-center'>
						...
						<div>
							<ul className='list-unstyled fs-2 d-flex flex-column flex-sm-row gap-sm-3'>
